...
class PasswordApp(ctk.CTk):
    def __init__(self):
        ...
        self.title_label = ctk.CTkEntry(frame, font=("Arial", 20, "bold"),
                                        ...
                                        width=300,
                                        justify="center")
        self.title_label.place(relx=0.52, y=self.y1, anchor=tk.CENTER)
        ...
        self.add_separator(self.y2)  # 60

        # Barre de mot de passe avec le bouton de régénération
        self.password_entry = ctk.CTkTextbox(frame, width=260, height=37, font=("Courier", 16),
                                             border_width=3)  # justify="center"
        self.password_entry.insert("end", "r2f477e5d4")  # exemple de mot de passe généré
        self.password_entry.place(relx=0.44, y=self.y2 + 40, anchor=ctk.CENTER)
        ...
        self.regen_button.place(x=330, y=self.y2 + 40, anchor=ctk.CENTER)

        self.pass_type_frame = ctk.CTkFrame(frame, width=310, height=31, corner_radius=10, fg_color="transparent")
        self.pass_type_frame.place(relx=0.5, y=self.y2 + 100, anchor=ctk.CENTER)
        ...
        self.random_button.place(relx=0.16, y=0.5, anchor=ctk.CENTER)
    ...
    def regenerate_password(self):
        ...
        self.password_entry.delete(0.1, tk.END)
